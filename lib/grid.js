...
(function() {
  'use strict';
  var CELLS, CND, LETTERS, alert, assign, badge, debug, echo, help, info, jr, log, new_xregex, rpr, urge, warn, whisper;
  ...
  this.parse_rangekey = function(grid, rangekey) {
    var bottom_digits, bottomleft_key, bottomright_key, cellkey_1, cellkey_2, cellkeys, cellref_1, cellref_2, left_letters, right_letters, top_digits, topleft_key, topright_key;
